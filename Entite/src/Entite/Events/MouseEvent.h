...
namespace Entite {
	class ENTITE_API MouseMovedEvent : public Event
	{
	public:
	...
	class ENTITE_API MouseButtonEvent : public Event
	{
	public:
	...
	class ENTITE_API MouseButtonPressedEvent : public MouseButtonEvent
	{
	public:
	...
	class ENTITE_API MouseButtonReleasedEvent : public MouseButtonEvent
	{
	public:
